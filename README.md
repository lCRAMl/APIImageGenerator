...
SplashScreenPython/      Git-Submodul: Info-Fenster (ℹ-Knopf)
assets/                  Icon, Stern-Symbol, Splash-Bild
...
```
git clone --recurse-submodules https://github.com/lCRAMl/APIImageGenerator.git
...
Startmenü-Verknüpfung. Die Version kommt aus `git describe --tags`.
